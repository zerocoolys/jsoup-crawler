...
public class Pools {
	...
	private static BlockingQueue<String> urlpool = new LinkedBlockingQueue<String>(
			5000);

	private static BlockingQueue<Document> docpool = new LinkedBlockingQueue<Document>(
			500);
