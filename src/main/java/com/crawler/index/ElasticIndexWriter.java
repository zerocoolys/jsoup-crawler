...
public class ElasticIndexWriter {
    public static org.slf4j.Logger LOG = LoggerFactory.getLogger(ElasticIndexWriter.class);
...
//        clusterName = nullToEmpty(System.getProperties().get(ElasticConstants.CLUSTER));
//        host = nullToEmpty(System.getProperties().get(ElasticConstants.HOST));
//        port = System.getProperties().getInt(ElasticConstants.PORT, -1);
//
...
//        Element summarydoc = document.getElementById("summary");
//    }
}
